    ...
    <div class="text-center p-6">
      ...
      <div class="text-left bg-gray-50 rounded-lg p-4 mb-6">
        ...
        <ul class="text-sm text-gray-600 space-y-1">
          <li>• Seu email: <code class="bg-white px-2 py-1 rounded">{{ userEmail }}</code></li>
          <li>• Data/Hora: <code class="bg-white px-2 py-1 rounded">{{ currentDateTime }}</code></li>
      ...
      <div class="mt-4 pt-4 border-t border-gray-200">
        <p class="text-xs text-gray-500">
          ...
          <a href="mailto:admin@tylerlimaeler.org" class="text-blue-600 hover:underline">
