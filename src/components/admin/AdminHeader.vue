<template>
  ...
  >
    ...
    <nav class="space-y-2">
      ...
      <RouterLink to="/admin/goals" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
      ...
      <RouterLink to="/admin/raffles" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
      ...
      <RouterLink to="/admin/events" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
      ...
      <RouterLink to="/admin/orders" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
      ...
      <RouterLink to="/admin/donations" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
      ...
      <RouterLink to="/admin/security" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
      ...
      <RouterLink to="/admin/settings" class="admin-nav-link">
        <svg
          class="w-5 h-5"
          fill="none"
          stroke="currentColor"
    ...
    <div class="mt-8 pt-8 border-t border-gray-800">
      <button
        @click="handleLogout"
        class="w-full text-left admin-nav-link text-red-400 hover:bg-red-900/20"
      >
        <svg
          class="w-5 h-5"
          fill="none"
...
.admin-nav-link.router-link-active {
  @apply bg-tyler-blue text-white;
}
</style>
