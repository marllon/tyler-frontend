    ...
    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <div
          ...
          class="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg text-left"
        >
          ...
          <div class="text-xs text-orange-600 space-y-1">
            <p>
              <span class="font-mono">admin@tyler.com</span> /
              <span class="font-mono">admin123</span>
            </p>
            <p>
              Google OAuth simulará:
              <span class="font-mono">marllon.nasser@gmail.com</span>
            </p>
          </div>
        ...
        <div
          v-else
          class="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg text-left"
        >
          <p class="text-sm font-medium text-green-800 mb-1">
            🔥 Firebase Configurado
          </p>
          <p class="text-xs text-green-700">
            Use suas credenciais Google reais
          </p>
        </div>
      </div>
