    ...
    <div class="container mx-auto px-4">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
          Concorra a prêmios incríveis e ajude o Projeto Tyler Lima Eler. Cada bilhete é uma contribuição que faz a diferença!
        </p>
      </div>
      ...
      <!-- Loading State -->
      <div v-if="rafflesStore.loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div v-else-if="rafflesStore.raffles.length > 0">
        ...
        >
          ...
          <span class="text-gray-600 font-medium">
            Página {{ rafflesStore.pagination.page + 1 }} de {{ rafflesStore.pagination.totalPages }}
          </span>
      ...
      <div v-else class="text-center py-20">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-2">Nenhuma rifa disponível</h3>
        <p class="text-gray-600">No momento não há rifas ativas. Volte em breve para participar!</p>
      </div>
    </div>
  </div>
</template>
